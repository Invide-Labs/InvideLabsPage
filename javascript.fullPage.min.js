...
b=[40,38,33,34],e=0;e<b.length;e++)b[e]==c&&J(a);var h=a.shiftKey;Qa=setTimeout(function(){switch(c){case 38:case 33:V();break;case 40:case 34:ha();break;case 36:W(1);break;case 35:W(p(".fp-section").length);break;case 37:Y();break;case 39:X()}},150)}};null!==e(".fp-slidesNav a")&&K(e(".fp-slidesNav a"),"click onclick touchstart",function(a){J(a);a=I(this,function(a){return w(e1,"fp-section")});a=e(".fp-slides",a);var b=I(this,function(a){return"li"===a.tagName}),b=q(b),

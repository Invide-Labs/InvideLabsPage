  ...
  if (showOnScroll && showModal) {
      window.addEventListener('scroll', function (e) {
          if (this.scrollY > 2500 && showModal) {
              showModal = false;
              modal.open();
          }
      })
